...
/*! @name Creating a WYObject */

/*!
 Creates a new WYObject with a class name.
...
/*!
 Creates a new WYObject with a class name, initialized with data constructed from the specified set of objects and keys.
 @param className The object's class.
 @param dictionary An NSDictionary of keys and objects to set on the new WYObject.
 @result A WYObject with the given class name and set with the given data.
 */
+ (WYObject *)objectWithClassName:(NSString *)className dictionary:(NSDictionary *)dictionary;

/*!
 Initializes a new WYObject with a class name.
 ...
 */
@property (readonly) NSString *wyClassName;
 ...
 */
//@property (nonatomic, retain) WYACL *ACL;
 ...
 */
//- (WYRelation *)relationForKey:(NSString *)key;
...
/*!
 Saves the WYObject and sets an error if it occurs.
...
/*!
 Saves the WYObject asynchronously.
 */
- (void)saveInBackground;

/*!
 Saves the WYObject asynchronously and executes the given callback block.
...
/*!
 ...
 can be saved.
 */
//- (void)saveEventually:(WYBooleanResultBlock)callback;
...
/*!
 Gets whether the WYObject has been fetched.
 @result YES if the WYObject is new or has been fetched or refreshed.  NO otherwise.
 */
...
/*!
 Refreshes the WYObject with the current data from the server.
 */
- (void)refresh;

/*!
 Refreshes the WYObject with the current data from the server and sets an error if it occurs.
 @param error Pointer to an NSError that will be set if necessary.
 */
- (void)refresh:(NSError **)error;

/*!
 Refreshes the WYObject asynchronously and executes the given callback block.
 @param block The block to execute. The block should have the following argument signature: (WYObject *object, NSError *error)
 */
- (void)refreshInBackgroundWithBlock:(WYObjectResultBlock)block;

/*!
 Refreshes the WYObject asynchronously and calls the given callback.
 @param target The target on which the selector will be called.
 @param selector The selector to call. It should have the following signature: (void)callbackWithResult:(WYObject *)refreshedObject error:(NSError *)error. error will be nil on success and set if there was an error. refreshedObject will be the WYObject with the refreshed data.

- (void)refreshInBackgroundWithTarget:(id)target selector:(SEL)selector;
  */

/*!
 Fetches the WYObject with the current data from the server.
 */
- (void)fetch;
/*!
 Fetches the WYObject with the current data from the server and sets an error if it occurs.
 @param error Pointer to an NSError that will be set if necessary.
 */
- (void)fetch:(NSError **)error;

/*!
 Fetches the WYObject's data from the server if isDataAvailable is false.
- (WYObject *)fetchIfNeeded;

*!
 Fetches the WYObject's data from the server if isDataAvailable is false.
 @param error Pointer to an NSError that will be set if necessary.

- (WYObject *)fetchIfNeeded:(NSError **)error;
  */

- (void)fetchInBackgroundWithBlock;
/*!
 Fetches the WYObject asynchronously and executes the given callback block.
 @param block The block to execute. The block should have the following argument signature: (WYObject *object, NSError *error)
 */
- (void)fetchInBackgroundWithBlock:(WYObjectResultBlock)block;

/*!
 Fetches the WYObject asynchronously and calls the given callback.
 @param target The target on which the selector will be called.
 @param selector The selector to call. It should have the following signature: (void)callbackWithResult:(WYObject *)refreshedObject error:(NSError *)error. error will be nil on success and set if there was an error. refreshedObject will be the WYObject with the refreshed data.
...
/*!
 Fetches the WYObject's data asynchronously if isDataAvailable is false, then calls the callback block.
 @param block The block to execute.  The block should have the following argument signature: (WYObject *object, NSError *error)

- (void)fetchIfNeededInBackgroundWithBlock:(WYObjectResultBlock)block;
  */
...
/*!
 Fetches all of the WYObjects with the current data from the server
 @param objects The list of objects to fetch.
 */
+ (void)fetchAll:(NSArray *)objects;

/*!
 Fetches all of the WYObjects with the current data from the server and sets an error if it occurs.
 @param objects The list of objects to fetch.
 @param error Pointer to an NSError that will be set  if necessary
 */
...
/*!
 Fetches all of the WYObjects with the current data from the server asynchronously and calls the given block.
 @param objects The list of objects to fetch.
...
/*!
 Fetches all of the WYObjects with the current data from the server asynchronously and calls the given callback.
 @param objects The list of objects to fetch.
 @param target The target on which the selector will be called.
 @param selector The selector to call. It should have the following signature: (void)callbackWithResult:(NSArray *)fetchedObjects error:(NSError *)error. error will be nil on success and set if there was an error. fetchedObjects will the array of WYObjects that were fetched.
...
/*!
 ...
 @param objects The list of objects to fetch.
 @param target The target on which the selector will be called.
 @param selector The selector to call. It should have the following signature: (void)callbackWithResult:(NSArray *)fetchedObjects error:(NSError *)error. error will be nil on success and set if there was an error. fetchedObjects will the array of WYObjects
 that were fetched.
...
/*
 Deletes the WYObject.
 @result Returns whether the delete succeeded.
 */
- (BOOL)delete;

/*!
 Deletes the WYObject and sets an error if it occurs.
 @param error Pointer to an NSError that will be set if necessary.
 @result Returns whether the delete succeeded.
 */
...
/*!
 Deletes the WYObject asynchronously.
 */
- (void)deleteInBackground;

/*!
 Deletes the WYObject asynchronously and executes the given callback block.
 @param block The block to execute. The block should have the following argument signature: (BOOL succeeded, NSError *error)
 */
- (void)deleteInBackgroundWithBlock:(WYBooleanResultBlock)block;

/*!
 Deletes the WYObject asynchronously and calls the given callback.
 @param target The object to call selector on.
