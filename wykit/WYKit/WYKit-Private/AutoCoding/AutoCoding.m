...
- (void)setWithCoder:(NSCoder *)aDecoder
{
    ...
    {
        if ([[self excludeProperties] containsObject:key]) {
            continue;
        }
        id object = nil;
        ...
        if (object)
        {
            ...
            if ([object isKindOfClass:[NSDictionary class]] && [NSStringFromClass(propertyClass) isEqualToString:@"NSMutableDictionary"]) {
                object = [[NSMutableDictionary alloc] initWithDictionary:object];
            }
    ...
    if ([self isKindOfClass:[WYFile class]]) {
        WYFile *fileSelf = (WYFile*)self;
        [fileSelf afterDecoder];
    }
